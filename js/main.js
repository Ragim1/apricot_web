(function ($) {
    ...
    $('.add_to_cart').on('click', function () {
        var name = $(this).closest('.container').find('.product-detail-name').text();
        var price = $(this).closest('.container').find('.m-text17').text();
        var size = $(this).closest('.container').find('.selection-2_size').val();
        var color = $(this).closest('.container').find('.selection-2_color').val();
        // $.trim(name);
